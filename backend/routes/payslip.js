// backend/routes/payslip.js  (updated — worker role access added)
...
router.get('/:entry_id', verifyToken, async (req, res) => {
  try {
    ...
    // Shift Incharge: only their own submissions
    // Worker: only entries where their name appears in worker_name
    ...
    doc.fillColor('white').fontSize(10)
      .text(
        ...
        0, 56, { align: 'right', width: doc.page.width - 50 }
      );
    ...
    const ROLE_LABEL = {
      shift_incharge: 'Shift Incharge', hod: 'HOD',
      superintendent: 'Superintendent', hr: 'HR',
    };
